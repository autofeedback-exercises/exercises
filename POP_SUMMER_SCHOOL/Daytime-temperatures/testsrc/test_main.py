...
class UnitTests(unittest.TestCase):
   ...
   def test_moongraph1(self):
       ...
       temperatures = (1361*(1-0.12)*np.cos(15*np.pi*(times-12)/180) / (0.98*5.67E-8) )**(1/4)
       line1, axislabels = line(times, temperatures), ["time of day", "Temperature at equator / K"]
   ...
   def test_moongraph2(self):
       ...
       line1, axislabels = line(new_times, temperatures), ["time / Earth days", "Temperature at equator / K"]
       assert pc.check_plot(
            [line1], explabels=axislabels, explegend=False, output=True
        )
